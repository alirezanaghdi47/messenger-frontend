...
const footerLinks = [
    ...
    {id: 2, title: "list.story", href: "/story", icon: <LuDisc size={20}/>},
    {id: 3, title: "list.voiceCall", href: "/voice-call", icon: <FiPhone size={20}/>},
    {id: 4, title: "list.videoCall", href: "/video-call", icon: <FiVideo size={20}/>},
